...
const NavBar = () => {
  ...
  return (<>
        <Flex w={'100%'} flexDir={'row'} gap={3} px={4} pt={2} justifyContent={'space-between'} alignItems={'center'}>
          {/* <Box display={{base: 'none', md: 'none', lg: 'none'}} alignItems={'center'} fontWeight={'600'} gap={1}>
            {showNav
          ...
          <Flex gap={{md: 5, lg: 3, xl: 5}} overflow={'hidden'} position={'unset'} w={'full'} justifyContent={'space-between'}>
            <Box display={'flex'} cursor={'pointer'} pl={{md: 3, lg:4}} alignItems={'center'} fontWeight={800}> 
              <Box display={!isLargerThan800? 'block': 'none'} px={2}>
              ...
              <BsHouse size={24}/>
              <Text minW={'190px'} fontSize={'clamp(12px, 2vw, 16px)'} as={RouterLink} to={'/'}  cursor={'pointer'}  color={'rgb(26 62 52)'}>
                Housing Solutions Hub
              </Text>
            </Box>
        ...
        <Flex w={'100%'} display={isLargerThan800? 'flex': 'none'} flexDir={'column'} justifyContent={'center'}>
          <Divider mt={'4px'}/>
          <Box display={{base: 'flex',md: 'flex'}} maxW={'100%'} w={{sm: 'auto', lg: '85%'}} justifyContent={'space-evenly'} alignItems={'center'} >
        ...
        >
          ...
          <Flex flexDir={'column'} w={'full'} h={'90%'} mt={'20px'} justifyContent={'space-between'} overflow={'auto'}>
            <UnorderedList listStyleType={'none'} display={'flex'} alignItems={'flex-start'} justifyContent={'flex-start'} gap={4}
              flexDirection={'column'} m={0} fontWeight={'bold'}
            >
